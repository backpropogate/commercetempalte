...
const Faq = () => {
  return (
    ...
    <details className="mb-4">
        <summary className="flex justify-between items-center bg-white p-2.5 cursor-pointer text-[#1f1f21] outline-none" tabIndex="0">How long does shipping take?</summary>
    ...
    <details className="mb-4">
        <summary className="flex justify-between items-center bg-white p-2.5 cursor-pointer text-[#1f1f21] outline-none" tabIndex="0">What is your return policy?</summary>
    ...
    <details className="mb-4">
        <summary className="flex justify-between items-center bg-white p-2.5 cursor-pointer text-[#1f1f21] outline-none" tabIndex="0">How can I track my order?</summary>
    ...
    <details className="mb-4">
        <summary className="flex justify-between items-center bg-white p-2.5 cursor-pointer text-[#1f1f21] outline-none" tabIndex="0">Do you ship internationally?</summary>
        <p className="p-2.5">Yes, we ship to most countries worldwide. Shipping fees and times may vary based on your location.</p>
    </details>

    <details className="mb-4">
        <summary className="flex justify-between items-center bg-white p-2.5 cursor-pointer text-[#1f1f21] outline-none" tabIndex="0">Can I change or cancel my order?</summary>
